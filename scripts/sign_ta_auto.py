...
def main():
	...
	gen_cert_cmd.extend(["--market_id=" + args.market_id])
	gen_cert_cmd.extend(["--chipset_id=" + args.chipset_id])
	...
	sign_cmd.extend(["--market_id=" + args.market_id])
	sign_cmd.extend(["--chipset_id=" + args.chipset_id])
